...
var hosroscopeRoutest_exports = {};
__export(hosroscopeRoutest_exports, {
  default: () => horoscopeRoutes
});
module.exports = __toCommonJS(hosroscopeRoutest_exports);
...
// src/routes/hosroscopeRoutest.ts
async function horoscopeRoutes(fastify) {
